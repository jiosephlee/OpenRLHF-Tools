"""Build v16 TDC datasets in OpenAI chat format.

Same records and splits as :mod:`data.tdc.build_v14_consolidated_datasets`, but
the system message documents the five compact feature buckets exposed by
``openrlhf.tools.therapeutic_tools.v16``.

Usage:
    python data/tdc/build_v16_datasets.py \\
        [--output-dir data/tdc/openai_format_v16]
"""
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v16")
...
def main():
    parser = argparse.ArgumentParser(description="Build v16 TDC datasets")
