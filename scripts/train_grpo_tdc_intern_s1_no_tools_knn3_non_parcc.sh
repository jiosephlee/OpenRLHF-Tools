...
# Usage:
#   # Colocated (default):
#   bash scripts/train_grpo_tdc_intern_s1_no_tools_knn3_non_parcc.sh
#
#   # With features:
#   TIS=1 TIS_TYPE=tis LIGER_GRPO_LOSS=1 LOSS_TYPE=dapo SMART_REPLAY=1 bash scripts/train_grpo_tdc_intern_s1_no_tools_knn3_non_parcc.sh
#
#   # Distributed:
#   MODE=distributed ACTOR_GPUS=2 VLLM_NUM_ENGINES=2 bash scripts/train_grpo_tdc_intern_s1_no_tools_knn3_non_parcc.sh
#
#   # LoRA:
#   USE_LORA=1 LEARNING_RATE=2e-5 bash scripts/train_grpo_tdc_intern_s1_no_tools_knn3_non_parcc.sh
#
