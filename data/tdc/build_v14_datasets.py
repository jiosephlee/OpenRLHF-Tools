"""Build v14 TDC datasets in OpenAI chat format.

Same as v13 but system prompts list v14 ``FEATURE_NAMES`` (metabolites removed;
extra cache-backed scalars documented in ``openrlhf.tools.therapeutic_tools.v14``).

Usage:
    python data/tdc/build_v14_datasets.py [--output-dir data/tdc/openai_format_v14]

Source SMILES: ``data/tdc/raw_deduplicated`` (same as v11/v12/v13).
"""
...
from openrlhf.tools.therapeutic_tools.v14 import FEATURE_NAMES  # noqa: E402
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v14")
...
def main():
    parser = argparse.ArgumentParser(description="Build v14 TDC datasets")
