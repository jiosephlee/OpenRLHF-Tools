"""Build v14_consolidated_no_neighbor TDC datasets in OpenAI chat format.

Same records and splits as :mod:`data.tdc.build_v14_consolidated_datasets`, but
the system message only documents ``get_features`` because neighbor tools are
not exposed for this surface.

Usage:
    python data/tdc/build_v14_consolidated_no_neighbor_datasets.py \\
        [--output-dir data/tdc/openai_format_v14_consolidated_no_neighbor]
"""
...
from openrlhf.tools.therapeutic_tools.v14_consolidated_no_neighbor import FEATURE_NAMES  # noqa: E402
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v14_consolidated_no_neighbor")
...
def main():
    parser = argparse.ArgumentParser(description="Build v14_consolidated_no_neighbor TDC datasets")
