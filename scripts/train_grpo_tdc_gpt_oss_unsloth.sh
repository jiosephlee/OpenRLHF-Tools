#!/bin/bash
#
# GPT-OSS GRPO training — Unsloth BF16 version.
#
...
conda activate /vast/projects/myatskar/design-documents/conda_env/openrlhf_tfv4 # This conda env uses torch 2.9.1, and the corresponding flash-attn for cuda 13.1.0, but torch is compiled for cuda 12.8... torch doesn't have pip wheels for 13.1.0 yet; no problems with this for now except for Adam_offload.
set -euo pipefail
...
### ARGS ###
PRETRAIN_PATH=${1:-"unsloth/gpt-oss-20b-BF16"}
