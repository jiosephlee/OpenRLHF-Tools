"""Build v12 TDC datasets in OpenAI chat format.
...
Usage:
    python data/tdc/build_v12_datasets.py [--output-dir data/tdc/openai_format_v12]
"""
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v12")
...
def main():
    parser = argparse.ArgumentParser(description="Build v12 TDC datasets")
