"""Build local-attribution prompt artifacts for v17 ridge on official_v15."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build local-attribution artifacts for v17 ridge on official_v15")
