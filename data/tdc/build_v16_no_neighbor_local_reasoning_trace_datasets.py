"""Build direct SFT datasets from stored local reasoning-trace artifacts."""
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v16_no_neighbor_local_reasoning_trace")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build v16_no_neighbor local reasoning-trace TDC datasets")
