...
#
#   LIGER_GRPO_LOSS=1 LOSS_TYPE=dapo bash scripts/train_grpo_tdc_gpt_oss_no_tools_knn3_non_parcc.sh
#
#   # With features:
#   EFFECTIVE_ROLLOUT_BATCH_SIZE=8 EFFECTIVE_MINI_GRADIENT_STEPS=2 TIS=1 TIS_TYPE=tis REDUCE_OPTIMIZER=adam_offload TRAIN_MAX_TOKENS_PER_GPU=32768 LIGER_GRPO_LOSS=1 LOSS_TYPE=dapo SMART_REPLAY=1 bash scripts/train_grpo_tdc_gpt_oss_no_tools_knn3_non_parcc.sh
#
#   # LoRA:
#   USE_LORA=1 LEARNING_RATE=2e-5 bash scripts/train_grpo_tdc_gpt_oss_no_tools_knn3_non_parcc.sh
#
#   # Distributed:
#   MODE=distributed ACTOR_GPUS=1 VLLM_NUM_ENGINES=1 bash scripts/train_grpo_tdc_gpt_oss_no_tools_knn3_non_parcc.sh
#
...
### PRINT CONFIG ###
echo "========================================"
echo "TDC GRPO Training — GPT-OSS (No-Tools, KNN-3 Data, MODE=$MODE, BF16)"
echo "========================================"
