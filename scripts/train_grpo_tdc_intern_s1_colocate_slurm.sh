...
#
# Usage:
#   sbatch scripts/train_grpo_tdc_intern_s1_tools_FINAL_slurm.sh
#
# Override defaults via environment:
#   PRETRAIN_PATH=... LEARNING_RATE=5e-7 sbatch scripts/train_grpo_tdc_intern_s1_tools_FINAL_slurm.sh
#
