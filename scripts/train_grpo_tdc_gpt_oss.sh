...
#
# Usage:
#   EFFECTIVE_ROLLOUT_BATCH_SIZE=8 EFFECTIVE_MINI_GRADIENT_STEPS=2 TIS=1 TIS_TYPE=tis TRAIN_MAX_TOKENS_PER_GPU=40960 SMART_REPLAY=1 REDUCE_OPTIMIZER=adam_offload LIGER_GRPO_LOSS=1 LOSS_TYPE=gspo bash train_grpo_tdc_gpt_oss.sh
#   EFFECTIVE_ROLLOUT_BATCH_SIZE=8 EFFECTIVE_MINI_GRADIENT_STEPS=2 TIS=1 TIS_TYPE=tis TRAIN_MAX_TOKENS_PER_GPU=32768 SMART_REPLAY=1 REDUCE_OPTIMIZER=none LIGER_GRPO_LOSS=1 LOSS_TYPE=gspo bash train_grpo_tdc_gpt_oss.sh
#   # Distributed:
