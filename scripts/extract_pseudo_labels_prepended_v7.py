#!/usr/bin/env python3
"""Extract pseudo labels from prepended_tools_v7 prompts via majority vote
...
Usage:
    python scripts/extract_pseudo_labels_prepended_v7.py
"""
...
DATA_DIR = Path("data/tdc/prepended_tools_v7")
OUTPUT_PATH = Path("data/tdc/metadata/prepended_v7_pseudo_labels.json")
