"""Build v13 TDC datasets in OpenAI chat format.

Generates JSONL files with:
  - System message: chemist persona + available v13 feature names
  - User message: prompt template + SMILES + CoT instruction

Usage:
    python data/tdc/build_v13_datasets.py [--output-dir data/tdc/openai_format_v13]
"""
...
from openrlhf.tools.therapeutic_tools.v13 import FEATURE_NAMES  # noqa: E402
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v13")
...
def main():
    parser = argparse.ArgumentParser(description="Build v13 TDC datasets")
