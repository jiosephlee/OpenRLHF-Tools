"""Build v14_consolidated TDC datasets in OpenAI chat format.

Same records and splits as :mod:`data.tdc.build_v14_datasets`, but the system
message documents the grouped v11-style feature buckets exposed by
``openrlhf.tools.therapeutic_tools.v14_consolidated``.

Usage:
    python data/tdc/build_v14_consolidated_datasets.py \\
        [--output-dir data/tdc/openai_format_v14_consolidated]
"""
...
from openrlhf.tools.therapeutic_tools.v14_consolidated import FEATURE_NAMES  # noqa: E402
...
DEFAULT_OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "openai_format_v14_consolidated")
...
def main():
    parser = argparse.ArgumentParser(description="Build v14_consolidated TDC datasets")
