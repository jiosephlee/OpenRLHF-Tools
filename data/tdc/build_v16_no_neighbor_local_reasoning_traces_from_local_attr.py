"""Build local reasoning-trace artifacts by converting stored local-attribution artifacts."""
...
from data.tdc.ml_prompt_artifacts import (  # noqa: E402
    load_sample_prompt_map,
    sample_prompt_variant_dir,
    write_sample_prompt_records,
)

DEFAULT_DEBUG_DIR = _SCRIPT_DIR / "debug_v16_no_neighbor_local_reasoning_traces_from_local_attr"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Convert local-attribution artifacts into local reasoning-trace artifacts")
